     ...
     <footer class="bg-gray-800 text-white py-12">
        ...
        <div class="container">
            <div class="grid grid-cols-2 md:grid-cols-5 gap-8 border-b border-gray-700 pb-8">
                ...
                <div class="col-span-2 md:col-span-1 space-y-4">
                    ...
                    <p class="text-sm text-gray-400">
                        Patient-focused, reliable medical transport, committed to timely care and community well-being.
                    </p>
                </div>
                ...
                <!-- Contact Info -->
                <div class="space-y-3">
                    <h4 class="font-semibold text-white uppercase tracking-wider mb-3">Contact</h4>
                    <ul class="space-y-2 text-sm">
                        <li>
                            <p class="text-gray-400">Phone:</p>
                            <a href="tel:08160791374" class="text-red-500 hover:text-red-400 transition duration-200">08160791374</a>
                        </li>
                        <li>
                            <p class="text-gray-400">Email:</p>
                            <a href="mailto:medilyfthelp@gmail.com" class="text-red-500 hover:text-red-400 transition duration-200">medilyfthelp@gmail.com</a>
                        </li>
                    </ul>
                </div>
                ...
                <!-- Legal -->
                <div class="space-y-3">
                    <h4 class="font-semibold text-white uppercase tracking-wider mb-3">Legal</h4>
                    <ul class="space-y-2 text-sm">
                        <li><NuxtLink to="/privacy-policy" class="text-gray-400 hover:text-red-500 transition duration-200">Privacy Policy</NuxtLink></li>
                        <li><NuxtLink to="/terms" class="text-gray-400 hover:text-red-500 transition duration-200">Terms & Conditions</NuxtLink></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="mt-8 pt-4 text-center text-sm text-gray-500">
                &copy; {{ new Date().getFullYear() }} MediLyft. All rights reserved.
            </div>
        </div>
    </footer>
</template>