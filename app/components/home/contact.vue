    ...
    <section class="py-24 relative overflow-hidden">
        ...
        <div class=" mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <p class="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
                Our support team is available 24/7. Reach out now for emergency dispatch or to discuss partnership opportunities.
            </p>
            
            <div class="flex flex-col sm:flex-row justify-center items-center gap-6">
                <!-- Phone Button -->
                <a href="tel:08157612294" class="group relative px-8 py-4 bg-red-600/70 rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-105 active:scale-95 w-full sm:w-auto">
