      ...
      <main>
        <section class="py-24 relative overflow-hidden">
          <div class="mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h2 class="text-3xl md:text-5xl font-extrabold text-white mb-12 tracking-tight">
              Need a Fast, Reliable Ride?
            </h2>

            <div class="space-y-16 md:space-y-12">
              <div class="flex flex-col items-center">
                <p class="text-xl text-blue-100 mb-6 max-w-2xl leading-relaxed">
                  Our support team is available 24/7. Reach out now for emergency dispatch:
                </p>
                <a href="tel:08160791374" class="group relative px-8 py-4 bg-red-600/70 rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-105 active:scale-95 w-full sm:w-auto">
